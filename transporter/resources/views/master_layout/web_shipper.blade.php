...
<div class="main-wrapper">
      ...
      <div class="header-wrapper"><div class="container-fluid">
       ...
       <a class="logo" href="{{url('/')}}"><img src="{{asset('public/assets/bauenfreight/images/logo.png')}}"  alt="" class="img-responsive"></a>
        ...
        <div class="post-login-welcome">
            ...
            Welcome <a>
                Bienvenidos
               <?php /* @if(Session::has('web_user_name')) 
  ...
  <div class="left-nav">
  	...
  	<li><a href="{{url('your-quote')}}"><i class="fa fa-money  fa-fw"></i><span>Cotizar</span></a></li>
  	<li><a href="{{url('request-list')}}"><i class="fa fa-indent  fa-fw"></i><span>Cotizaciones en curso</span></a></li>
        <li class="active"><a href="{{url('shipper')}}"><i class="fa fa-home fa-fw"></i><span>Tracking</span></a></li>
        <li><a href="{{url('past-bids')}}"><i class="fa fa-gavel  fa-fw"></i><span>Mis Rutas</span></a></li>
  	<li><a href="{{url('message')}}"><i class="fa fa-envelope-o  fa-fw"></i><span>{{trans('pdg.79')}}</span></a></li>
