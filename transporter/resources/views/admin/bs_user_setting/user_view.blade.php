        ...
        <div class="widget-content nopadding">
            ...
            <form class="form-horizontal" method="GET" action="" >                
                 ...
                 <div class="control-group">
                    ...
                    <div class="controls " >  
                       <input type="text" name="user_email" value="@if(!empty($search['user_email'])){{$search['user_email']}}@endif">
                    </div>
                </div>
...
<!--<a href="#" class="btn btn-mini btn-primary pull-right button_class">Add New</a>-->
        ...
        <div class="pagination alternate pull-right">
            {!!$user_list->appends(['search_key'=>Request::get('search_key'),'user_email'=>Request::get('user_email')])->setPath('')->render()!!}
        </div>
        @else
