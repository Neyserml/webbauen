                                                   ...
                                                   <tr>
                                                       <td colspan="3">
                                                           <p style="font-size:16px;line-height:20px;padding:0;margin:0;margin-bottom:16px">
                                                                Welcome and thank you for registering with Bauen Freight App . 
                                                          Click the link below to activate your account to login.<br><br>
                                                           </p>
                                                       </td>
                                                   </tr>
                                                   <tr>
<td height="50" style="padding:0;margin:0;font-size:1;line-height:0" colspan="3"><img width="100%" height="1" src="" class=""></td>
                                                               ...
                                                               <tbody>
                                                                   <tr>
                                                                       <td align="center" style="margin:0;line-height:1em;font-size:16px;text-align:center" >
                                                                           <a href="{{ $data['active_account']}}" target="_blank" style="font-size:16px;text-decoration:none;color:#ffffff;font-weight:bold;padding:14px 32px;display:block" >Click Here</a>
                                                                       </td>
                                                                   </tr>
                                                               </tbody>
                                                           </table>
                                                   ...
                                                   <tr>
                                                       <td style="padding:0;margin:0;font-size:1;line-height:0" colspan="3">
                                                           ...
                                                           If you don't Registration  to reset your password, please ignore this email. Don't worry. Your password will be safe.<br>
