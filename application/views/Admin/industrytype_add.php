 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Industry Type Add</li>
      </ol>
    </section>
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="industrytype_name" name="industrytype_name" placeholder="Enter industry type name" value="<?=set_value('industrytype_name')?>">
