 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Document Type Edit</li>
      </ol>
    </section>
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="document_title" name="document_title" placeholder="Enter document title" value="<?=set_value('document_title',$documenttype['document_title'])?>">
                  ...
                  <select name="document_for" id="document_for" class="form-control" >
					...
					if(!empty($document_fors)){
						foreach($document_fors as $key=>$document_for){
							$selected='';
							if($key==set_value('document_for',$documenttype['document_for'])){
								$selected='selected';
							}
							?>
