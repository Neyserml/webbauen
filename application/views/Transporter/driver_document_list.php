...
?>
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Driver Documents</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
			  <?php 
				echo anchor(base_url(BASE_FOLDER_TRANS.'drivers/adddocument/'.$user['user_id']),'<i class="fa fa-plus"></i> Document',array('class'=>'pull-right btn btn-primary'));
			  ?>
			  <!-- filter oftion -->
            ...
            <div class="box-body">
              <table id="trnstable" class="table table-bordered table-striped">
				...
				<tr>
				  ...
				  ?></td>
                  <td><?php
					echo anchor(base_url(BASE_FOLDER_TRANS.'drivers/viewdocument/'.$row_id),"<i class='fa fa-eye'></i> View",array('class'=>'btn btn-info btn-sm'));
					
					if($is_blocked || $document['document_status']!=1){
					echo str_repeat('&nbsp;',1);
					echo anchor(base_url(BASE_FOLDER.'drivers/deletetblrecord/'.$row_id),"<i class='fa fa-trash'></i> Delete",array('class'=>'btn btn-danger mr-deleterow btn-sm','tbl_name'=>'user_documents'));
					}
				  ?></td>
                </tr>
						<?php
