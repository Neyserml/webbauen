        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
			  <?php 
				echo anchor(base_url(BASE_FOLDER_TRANS.'documents/add'),'<i class="fa fa-plus"></i> Document',array('class'=>'pull-right btn btn-primary'));
			  ?>
			  <!-- filter oftion -->
            ...
            <div class="box-body">
              <table id="trnstable" class="table table-bordered table-striped">
				...
				<tr>
				  ...
				  ?></td>
                  <td><?php
					echo anchor(base_url(BASE_FOLDER_TRANS.'documents/view/'.$row_id),"<i class='fa fa-eye'></i>  View",array('class'=>'btn btn-info btn-sm'));
